...
def test_select_by_category(empty_db):
    ...
    '''tests if can select items with a category'''
    tran0 = {'item': 'iPhone', 'amount': 100, 'category': 'cash', 'date': '2001/03/10', 'description': 'null'}
    tran1 = {'item': 'iPad', 'amount': 200, 'category': 'credit card', 'date': '2001/02/10', 'description': 'null'}
    tran2 = {'item': 'iWatch', 'amount': 300, 'category': 'debit card', 'date': '2001/01/10', 'description': 'null'}
    tran3 = {'item': 'AirPods', 'amount': 300, 'category': 'cash', 'date': '2001/01/10', 'description': 'null'}
    empty_db.add(tran0)
    empty_db.add(tran1)
    empty_db.add(tran2)
    empty_db.add(tran3)
    trans = empty_db.select_by_category()
    assert trans[0]['item'] == 'iPhone'
